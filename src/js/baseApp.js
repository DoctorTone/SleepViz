...
export class BaseApp {
  ...
  mouseClicked(event) {
    ...
    let intersects = this.raycaster.intersectObjects(
      this.scenes[this.currentScene].children,
      true
    );
  ...
  createScene() {
    ...
    directionalLight.position.set(
      SceneConfig.LightPos.x,
      SceneConfig.LightPos.y,
      SceneConfig.LightPos.z
    );
    directionalLight.castShadow = true;
    directionalLight.shadow.camera.near = 0.1;
    directionalLight.shadow.camera.far = 100;
    directionalLight.shadow.camera.right =
      SceneConfig.ShadowWidth + SceneConfig.ShadowExtra;
  ...
  createCamera() {
    ...
    this.camera = new THREE.PerspectiveCamera(
      SceneConfig.FOV,
      this.container.clientWidth / window.innerHeight,
      SceneConfig.NEAR_PLANE,
      SceneConfig.FAR_PLANE
    );
  ...
  createControls() {
    ...
    let lookAt = new THREE.Vector3(
      SceneConfig.LookAtPos.x,
      SceneConfig.LookAtPos.y,
      SceneConfig.LookAtPos.z
    );
